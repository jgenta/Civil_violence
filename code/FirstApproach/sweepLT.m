...
%% sweeps through the main using different value combinations for L and Thresh; can also be changed to check other values, then the for-loop needs to be modified
...
for L=minL:stepL:maxL                                                                       %sweep through all L values
    L                                                                                       %to visualize how far the run got
    counterThresh=1;
    for Thresh=minTresh:stepThresh:maxThresh                                                %sweep through all T values
        Thresh                                                                              %to visualize how far the run got
        summaxactive=0;                                                                     %reset values
...
%create axis vectors for plotting
